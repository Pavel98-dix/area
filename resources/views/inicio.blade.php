...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <!-- <h1 class="logo"><a href="index.html"><span>A.A</span></a></h1> -->
            <!-- Uncomment below if you prefer to use an image logo -->
            <a href="index.html" class="logo"><img src="assets/img/logo.jpeg" alt="logotipo" width="50px" height="80x"><span>A.A</span></a>
    ...
    <main id="main">
        ...
        <section id="counts" class="counts">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mb-3 mt-md-0">
                        <div class="count-box">
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Ubicación</h2>
                    <h3><span>¿Como puedo llegar?</span></h3>
                    <p>En caso de que reuiqeras la ubicación del lugar sede, se te proporciona este mapa que se vincula con google maps y así será más facil tu llegada.</p>
                </div>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-12 ">
                        <iframe class="mb-4 mb-lg-0" src="https://maps.google.com/maps?q=preparatoria%20oficial%20num%2029&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
